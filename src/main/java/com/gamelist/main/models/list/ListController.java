...
public class ListController {
	...
	@GetMapping("/games")
	public ResponseEntity<List<GameResponseDTO>> getGamesCollection(@RequestParam long collectionID) throws IOException{
		List<GameResponseDTO> response = listService.getGamesCollection(collectionID);
		return ResponseEntity.ok(response);
